"""ZIT View - Gradio UI for Z-Image-Turbo"""
...
def create_zit_tab():
    """Create the ZIT tab with all UI components."""
    ...
    with gr.Tab("ZIT"):
        ...
        # Row 2: Config (seed with random toggle, width, height)
        with gr.Row():
        ...
        # Row 3: LoRA list (collapsible) and output image
        with gr.Row():
        ...
        def start_generation(prompt, seed, randomize, width, height, loras):
        ...
        def handle_generate_click(prompt, seed, randomize, width, height, loras, current_btn_label):
            ...
            if generation_state.get("is_generating", False):
                ...
                # Start generation
                result, new_seed = start_generation(prompt, seed, randomize, width, height, loras)
        ...
        generate_btn.click(
            ...
            inputs=[prompt_input, seed_input, randomize_seed, width_input, height_input, lora_state, generate_btn],
