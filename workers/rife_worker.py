...
def main(unload_models: bool | None = None):
    ...
    try:
        with torch.inference_mode():
            ...
            primitiveint = NODE_CLASS_MAPPINGS["PrimitiveInt"]()
            primitiveint_53_22_21 = primitiveint.EXECUTE_NORMALIZED(value=672)
            primitiveint_53_51_50 = primitiveint.EXECUTE_NORMALIZED(value=1)
            primitiveint_53_51_42 = primitiveint.EXECUTE_NORMALIZED(value=60)
            vhs_videoinfosource = NODE_CLASS_MAPPINGS["VHS_VideoInfoSource"]()
            comfyswitchnode = NODE_CLASS_MAPPINGS["ComfySwitchNode"]()
            imageresizekjv2 = NODE_CLASS_MAPPINGS["ImageResizeKJv2"]()
            autorifetensorrt = NODE_CLASS_MAPPINGS["AutoRifeTensorrt"]()
            ...
            for q in range(1):
                ...
                comfyswitchnode_53_51_48 = comfyswitchnode.EXECUTE_NORMALIZED(
                    switch=["53:51:49", 2],
                    on_false=["53:51:47", 1],
                    on_true=get_value_at_index(primitiveint_53_51_50, 0),
                )
                comfyswitchnode_53_22_28 = comfyswitchnode.EXECUTE_NORMALIZED(
                    switch=["53:22:26", 2],
                    on_false=get_value_at_index(vhs_videoinfosource_53_52, 4),
                    on_true=get_value_at_index(vhs_videoinfosource_53_52, 3),
                )
                comfyswitchnode_53_22_30 = comfyswitchnode.EXECUTE_NORMALIZED(
                    switch=["53:22:26", 2],
                    on_false=get_value_at_index(vhs_videoinfosource_53_52, 3),
                    on_true=get_value_at_index(vhs_videoinfosource_53_52, 4),
                )
                comfyswitchnode_53_22_25 = comfyswitchnode.EXECUTE_NORMALIZED(
                    switch=["53:22:17", 2],
                    on_false=get_value_at_index(comfyswitchnode_53_22_30, 0),
                    on_true=["53:22:24", 1],
                )
                comfyswitchnode_53_22_18 = comfyswitchnode.EXECUTE_NORMALIZED(
                    switch=["53:22:17", 2],
                    on_false=get_value_at_index(comfyswitchnode_53_22_28, 0),
                    on_true=get_value_at_index(primitiveint_53_22_21, 0),
                )
                comfyswitchnode_53_22_31 = comfyswitchnode.EXECUTE_NORMALIZED(
                    switch=["53:22:26", 2],
                    on_false=get_value_at_index(comfyswitchnode_53_22_25, 0),
                    on_true=get_value_at_index(comfyswitchnode_53_22_18, 0),
                )
                comfyswitchnode_53_22_32 = comfyswitchnode.EXECUTE_NORMALIZED(
                    switch=["53:22:26", 2],
                    on_false=get_value_at_index(comfyswitchnode_53_22_18, 0),
                    on_true=get_value_at_index(comfyswitchnode_53_22_25, 0),
                )
                imageresizekjv2_37 = imageresizekjv2.resize(
                    width=get_value_at_index(comfyswitchnode_53_22_31, 0),
                    height=get_value_at_index(comfyswitchnode_53_22_32, 0),
                    upscale_method="nvidia_rtx_vsr",
                    keep_proportion="crop",
                    pad_color="0, 0, 0",
                    crop_position="center",
                ...
                autorifetensorrt_12 = autorifetensorrt.vfi(
                    clear_cache_after_n_frames=100,
                    multiplier=get_value_at_index(comfyswitchnode_53_51_48, 0),
                    keep_model_loaded=False,
                    frames=get_value_at_index(imageresizekjv2_37, 0),
                    rife_trt_model=get_value_at_index(autoloadrifetensorrtmodel_13, 0),
                )
