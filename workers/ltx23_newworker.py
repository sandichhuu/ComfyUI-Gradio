...
def main(unload_models: bool | None = None):
    ...
    try:
        with torch.inference_mode():
            loadimage = LoadImage()
            loadimage_246 = loadimage.load_image(image="hanfu.jpg")
            ...
            intconstant_252_91 = intconstant.get_value(value=25)
            primitivefloat = NODE_CLASS_MAPPINGS["PrimitiveFloat"]()
            primitivefloat_252_95 = primitivefloat.EXECUTE_NORMALIZED(value=5)
            ...
            cliptextencode_247_86 = cliptextencode.encode(
                text="Dancing", clip=get_value_at_index(dualcliploadergguf_254_239, 0)
            )
